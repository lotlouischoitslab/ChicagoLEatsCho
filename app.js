    ...
    return `<div class="card" data-idx="${idx}">
      ...
      <div class="card-footer">
        ...
        <div class="card-footer-links">
          ${r['Instagram'] ? `<a class="card-ig-btn" href="${r['Instagram']}" target="_blank" rel="noopener" onclick="event.stopPropagation()" title="View on Instagram">
...
function openModal(r) {
  ...
  document.getElementById('modalBody').innerHTML = `
    ...
    <div class="modal-cta-row">
      ...
      ${r['Instagram'] ? `<a href="${r['Instagram']}" target="_blank" rel="noopener" class="modal-cta modal-cta-ig">
